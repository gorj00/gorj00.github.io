...
/* harmony import */ var _content_home_form_form_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./content/home/form/form.component */ "./src/app/content/home/form/form.component.ts");
/* harmony import */ var _content_home_table_table_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./content/home/table/table.component */ "./src/app/content/home/table/table.component.ts");
...
/* harmony import */ var _content_home_home_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./content/home/home.component */ "./src/app/content/home/home.component.ts");
/* harmony import */ var _content_information_information_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./content/information/information.component */ "./src/app/content/information/information.component.ts");
...
const appRoutes = [
    { path: '', component: _content_home_home_component__WEBPACK_IMPORTED_MODULE_22__["HomeComponent"] },
    { path: 'information', component: _content_information_information_component__WEBPACK_IMPORTED_MODULE_23__["InformationComponent"] }
];
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _content_home_form_form_component__WEBPACK_IMPORTED_MODULE_18__["FormComponent"],
            _content_home_table_table_component__WEBPACK_IMPORTED_MODULE_19__["TableComponent"],
            _header_header_component__WEBPACK_IMPORTED_MODULE_21__["HeaderComponent"],
            _content_home_home_component__WEBPACK_IMPORTED_MODULE_22__["HomeComponent"],
            _content_information_information_component__WEBPACK_IMPORTED_MODULE_23__["InformationComponent"]
        ],
        imports: [
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_exchange_rate_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../services/exchange-rate.service */ "./src/app/services/exchange-rate.service.ts");
/* harmony import */ var _services_table_row_insertion_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/table-row-insertion.service */ "./src/app/services/table-row-insertion.service.ts");




let FormComponent = class FormComponent {
    constructor(exchangeRateService, tableRowInsertionService) {
        this.exchangeRateService = exchangeRateService;
        this.tableRowInsertionService = tableRowInsertionService;
    }
    // Makes 3 215 211 from 3215211
    makeSpacesInNumber(num) {
        if (this.amount) {
    ...
    showConvertedAmount() {
        if (this.amount && this.select) {
            const currencyPerDollar = this.rates[this.select];
            const convertedAmount = this.amount / currencyPerDollar;
    ...
    onInsertIntoTable() {
        ...
        const enteredAmountSelCode = this.makeSpacesInNumber(this.amount) + ' ' + this.select;
    ...
    ngOnInit() {
        ...
        this.exchangeRateService.getRates().subscribe((rates) => {
            this.rates = rates;
        }, error => console.log(error), () => console.log('getRates() completed!'));
    }
};
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_table_row_insertion_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../services/table-row-insertion.service */ "./src/app/services/table-row-insertion.service.ts");



let TableComponent = class TableComponent {
    constructor(tableRowInsertionService) {
        this.tableRowInsertionService = tableRowInsertionService;
        this.tableData = [];
        this.displayedColumns = ['amount', 'amount-in-usd'];
    }
    makeSpacesTableToal(tableTotal) {
...
], HeaderComponent.prototype, "languagePicked", void 0);
...
let ExchangeRateService = class ExchangeRateService {
    ...
    getRates() {
        return this.http.get(this.exchangeRatesURL)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(ratesData => ratesData.usd));
    }
};
ExchangeRateService.ctorParameters = () => [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TableRowInsertionService", function() { return TableRowInsertionService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let TableRowInsertionService = class TableRowInsertionService {
    constructor() {
        this.tableRows = [];
...
TableRowInsertionService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
