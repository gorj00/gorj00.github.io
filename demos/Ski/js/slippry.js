...
(function ($) {
  ...
  defaults = {
    ...
    slippryWrapper: '', // wrapper to wrap everything, including pager
    slideWrapper: '', // wrapper to wrap sildes & controls
    slideCrop: '', //additional wrapper around just the slides
...
jQuery(document).ready(function() {
  jQuery('#testimonials .testimonials-slider').slippry({
    slippryWrapper: '<div id="testimonials-wrapper" />',
  ...
  $(".sy-pager").insertAfter(".sy-filler");
});
